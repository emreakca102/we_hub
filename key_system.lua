-- Services (En başta tanımlandı)
local TS = game:GetService("TweenService")
local UIS = game:GetService("UserInputService")
local P = game:GetService("Players")
local HS = game:GetService("HttpService")
local Workspace = game:GetService("Workspace") -- Workspace de eklendi

-- Sets global functions (Bunlar global ortamda tanımlanmaya devam edecek)
...
function Lib:Init(Settings)
	...
	-- KeySystem.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui") -- Bu satır taşındı!
    ...
    -- KeySystem GUI'sini anahtar doğrulaması başarılı olduktan sonra PlayerGui'ye atayın
